#!/usr/bin/env python
"""
This module provides functionality to process text, extract emotions using a lexicon, and compute TF-IDF scores.
It includes the EmoTFIDF class for combining these features.
